...
BackgroundItem {
    ...
    onClicked: {
        ...
        drawer.open = false
        pageStack.pushAttached(Qt.resolvedUrl("../pages/ResultPage.qml"), { search_parameters: parameters })
    ...
    BackgroundItem {
        ...
        onClicked: {
            pageStack.pushAttached(Qt.resolvedUrl("../pages/ResultPage.qml"),
                                   {
                                       route_index: index,
