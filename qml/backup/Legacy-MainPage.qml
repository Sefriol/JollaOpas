    ...
    Drawer {
        ...
        background: SilicaListView {
            ...
            BackgroundItem {
                ...
                onClicked: console.log(favoriteRouteList.parent.children[0])
            }
        ...
        SilicaFlickable {
            ...
            Item {
                ...
                height: (favoriteRouteHeader.height + Theme.fontSizeSmall) * Theme.pixelRatio
                SpaceSeparator {
                    id: drawerfavoriteRouteHeader
                    type: qsTr("Favourites")
                }
            }
            SilicaListView {
                enabled:false
                id: fadingFavoriteRouteList
                anchors.top: drawerheaderitem.bottom
                ...
                delegate: ListItem {
                    ...
                    Label {
                        ...
                        height: Theme.itemSizeSmall
                        text: modelFromName + " - " + modelToName + " "
                        width: parent.width - fadingFavoriteRouteListButton.width
                        color: Theme.primaryColor
                        verticalAlignment: Text.AlignVCenter
                        horizontalAlignment: Text.AlignHCenter
                        elide: Text.ElideRight
                    ...
                    IconButton {
                        id: fadingFavoriteRouteListButton
                        anchors.right: parent.right
                        icon.source: "image://theme/icon-m-shuffle"
                    }
                ...
                Rectangle {
                    ...
                    anchors {
                        fill: fadingFavoriteRouteList;
                        topMargin: (-fadingFavoriteRouteList.height / 2);
                    }
                }
                property Item contextMenu
            ...
            MouseArea {
                enabled: !drawer.open
                anchors.fill: fadingFavoriteRouteList
